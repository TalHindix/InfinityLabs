...
# Output binary
.DEFAULT_GOAL := $(BUILD_DIR)/linear_sorting_test.out
TARGET := $(BUILD_DIR)/linear_sorting_test.out

# Sources and objects
SRC := $(SORTING_SRC_DIR)/linear_sorting.c $(SORTING_TEST_DIR)/linear_sorting_test.c
OBJS := $(SRC:.c=.o)
