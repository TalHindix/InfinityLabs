...
inline Complex& Complex::operator*=(const Complex& rhs)
{
    ...
    double newImaginary = m_real * rhs.m_imaginary +
                          m_imaginary * rhs.m_real; // Delete the newImaginary
...
inline Complex& Complex::operator/=(const Complex& rhs)
{
    ...
    double newImaginary =
        (m_imaginary * rhs.m_real - m_real * rhs.m_imaginary) /
        denominator; // Delete the newImaginary
