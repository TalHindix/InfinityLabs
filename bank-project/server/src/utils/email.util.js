...
const buildOtpEmailTemplate = (otp) => wrapInEmailLayout(`
...
const fireAndForget = (label, guardObj, promiseFn) => {
...
export const sendOtpEmailAsync = (email, otp) =>
  fireAndForget('OTP', { email, otp }, () => sendOtpEmail(email, otp));
...
export const sendVerificationEmailAsync = (email, token) =>
  fireAndForget('verification', { email, token }, () => sendVerificationEmail(email, token));
...
export const sendTransferNotificationEmailAsync = (params) =>
  fireAndForget('transfer', { receiverEmail: params?.receiverEmail }, () => sendTransferNotificationEmail(params));
